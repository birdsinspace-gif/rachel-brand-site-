...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F2] text-[#1C1917]">
      <section className="overflow-hidden border-b border-[#E7E0D6]">
        <div className="mx-auto max-w-6xl px-6 py-32 md:px-10">
          ...
          >
            Brand strategy for organizations that have{" "}
            <span className="text-[#3F4F3F]">outgrown</span> their current story.
          </motion.h1>
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-20 md:px-10">
          <motion.p
            ...
            className="text-sm font-medium uppercase tracking-[0.24em] text-[#6B645C]"
          >
      ...
      >
        ...
        >
          Strategy applied across categories and stages of growth.
        </motion.h2>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {experienceItems.map((item, i) => (
            <motion.div
              ...
              className="rounded-[1.5rem] border border-[#E3DBCF] bg-white p-6 shadow-[0_8px_30px_rgba(28,25,23,0.04)]"
            >
              <p className="text-base leading-7 text-[#3F3A35]">{item}</p>
            </motion.div>
          ))}
      ...
      >
        <div className="mx-auto max-w-5xl px-6 py-24 text-center md:px-10">
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="text-sm font-medium uppercase tracking-[0.24em] text-[#B7C2B2]"
          >
            Contact
          </motion.p>
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-[#D7DED3]"
          >
